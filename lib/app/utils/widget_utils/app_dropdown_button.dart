...
class TVSIDropDownButton<T> extends StatefulWidget {
  TVSIDropDownButton({
    Key? key,
    required this.items,
  ...
  @override
  State<TVSIDropDownButton<T>> createState() => _TVSIDropDownButtonState<T>();
}

class _TVSIDropDownButtonState<T> extends State<TVSIDropDownButton<T>>
  ...
  @override
  void didUpdateWidget(TVSIDropDownButton<T> oldWidget) {
